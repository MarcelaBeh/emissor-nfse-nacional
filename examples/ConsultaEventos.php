...
try {
    $eventos = $facade->consultarEventos($chave);
    echo 'Eventos encontrados: ' . count($eventos) . PHP_EOL;
    print_r($eventos);

    // Com filtro por tipo e sequencial:
    // $eventos = $facade->consultarEventos($chave, '1', 1);
} catch (\Throwable $e) {
