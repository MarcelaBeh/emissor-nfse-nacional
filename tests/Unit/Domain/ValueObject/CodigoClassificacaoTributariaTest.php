...
final class CodigoClassificacaoTributariaTest extends TestCase
{
    public function test_valid_codigo(): void
    {
        $codigo = new CodigoClassificacaoTributaria('123456');
        $this->assertSame('123456', $codigo->getCodigo());
    }

    public function test_codigo_with_leading_zeros(): void
    {
        $codigo = new CodigoClassificacaoTributaria('001234');
        $this->assertSame('001234', $codigo->getCodigo());
    }

    public function test_too_short_throws_exception(): void
    {
        $this->expectException(ValidationException::class);
        new CodigoClassificacaoTributaria('12345');
    }

    public function test_too_long_throws_exception(): void
    {
        $this->expectException(ValidationException::class);
        new CodigoClassificacaoTributaria('1234567');
    }

    public function test_with_letters_throws_exception(): void
    {
        $this->expectException(ValidationException::class);
        new CodigoClassificacaoTributaria('12345a');
    }
